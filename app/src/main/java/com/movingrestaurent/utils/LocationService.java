...
public class LocationService implements LocationListener,
	...
	private LocationService(Context locationActivity) {
	...
	public static LocationService getInstance(Context locationActivity) {
		if (instance == null) {
			instance = new LocationService(locationActivity);
		}
		return instance;
	}
			...
			Executors.newScheduledThreadPool(1).schedule(new Runnable() {
				...
				public void run() {
					fusedLocationProviderApi.removeLocationUpdates(
							googleApiClient, LocationService.this);
				}
