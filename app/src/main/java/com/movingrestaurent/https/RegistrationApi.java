...
public class RegistrationApi {
    public static void onRegistration(String URL, final Context context,String first_name,String last_name, String email, String mobile,String password,String userType,String profileStr,String latitude,String longitude,String restName,String restDescrip,String restauraAddress) {
        final OnRegistration callback = (OnRegistration) context;
