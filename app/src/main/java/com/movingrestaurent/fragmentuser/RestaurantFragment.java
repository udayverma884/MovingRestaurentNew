 ...
 */
public class RestaurantFragment extends Fragment  implements View.OnClickListener, OnMapReadyCallback,OnFetchRestaurant {
    ...
    private void initMap() {
        ...
        if (mGoogleMap != null) {
            ...
            mGoogleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(Double.parseDouble(lat), Double.parseDouble(longi)), 12.0f));
*/
